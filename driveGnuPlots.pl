...
sub main {
    ...
    print PIPE "set style line 1 linecolor rgb '#0000FF'\n";
    print PIPE "set style line 2 linecolor rgb '#FF0000'\n";
	...
	if ($numberOfStreams == 1) {
	    print $pip "plot \"-\" with linespoint ls 1\n";
	} else {
        if($streamIdx == 0){
	       print $pip "plot \"-\" with linespoint ls 1 title '$title'\n";
        } else {
           print $pip "plot \"-\" with linespoint ls 2 title '$title'\n";
        }
	}
	my $cnt = 0;
